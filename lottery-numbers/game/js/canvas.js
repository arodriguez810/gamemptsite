...
var guideline, bg, logo, buttonStart, buttonContinue, buttonFacebook, buttonTwitter, buttonWhatsapp, buttonFullscreen,
...
function buildGameCanvas() {
  ...
  buttonFacebook.x = -9000;
  buttonTwitter.x = -9000;
  buttonWhatsapp.x = -9000;
  buttonFacebook.y = -9000;
